...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Carne, fuego y tiempo. Parrilla en Madrid construida sobre producto honesto y brasa de encina.',
    type: 'website',
    locale: 'es_ES'
  }
};
...
const jsonLd = {
  ...
  '@type': 'Restaurant',
  name: 'Lost Grill',
  description: 'Parrilla en Madrid. Brasa de encina, carnes maduradas y producto honesto.',
  servesCuisine: 'Parrilla, Asador',
  address: {
    '@type': 'PostalAddress',
